...
const team = [
  {
    ...
    description: 'Passionnée d\'e-commerce depuis 15 ans'
  },
  {
    name: 'Pierre Martin',
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h1 className="text-4xl lg:text-6xl font-bold text-gray-900 mb-6">
              À propos de
              <span className="bg-gradient-to-r from-orange-600 to-amber-600 bg-clip-text text-transparent block lg:inline"> MarketPlace</span>
            </h1>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Depuis 2014, nous révolutionnons l'expérience d'achat en ligne en connectant 
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <Badge className="mb-4 bg-orange-100 text-orange-800">Notre Histoire</Badge>
              <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
                Une vision, une passion
              </h2>
              <div className="space-y-4 text-gray-700 leading-relaxed">
                <p>
                  MarketPlace est né d'une vision simple : créer un espace où la qualité 
                  rencontre la diversité. Nous croyons que chaque produit a une histoire 
                ...
                <p>
                  Aujourd'hui, nous sommes fiers d'être la marketplace de référence pour 
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-orange-100 text-orange-800">Nos Valeurs</Badge>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
              Ce qui nous guide
            </h2>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <Badge className="mb-4 bg-orange-100 text-orange-800">Notre Équipe</Badge>
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-6">
              Les visages derrière MarketPlace
            </h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
